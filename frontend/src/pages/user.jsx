...
return (
  <div className="p-4 sm:p-6 max-w-5xl mx-auto">
    ...
    <div className="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-full mx-auto">
<table className="w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm sm:text-base table-auto">
  <thead className="bg-gray-50 dark:bg-gray-700">
    <tr>
      <th className="px-3 sm:px-6 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">ชื่อ</th>
      <th className="px-3 sm:px-6 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">ชื่อผู้ใช้งาน</th>
      <th className="px-3 sm:px-6 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">บทบาท</th>
    </tr>
  </thead>
  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
    ...
    {users.map(user => {
      ...
      return (
        <tr key={user.id} className="hover:bg-gray-100 dark:hover:bg-gray-700">
          ...
          <td className="px-3 sm:px-6 py-2 whitespace-nowrap">{user.username}</td>
          <td className="px-3 sm:px-6 py-2 whitespace-nowrap">{user.role}</td>

          <td className="px-3 sm:px-6 py-2 whitespace-nowrap text-center space-x-2">
            <button
    ...
    {/* Modal */}
    {isModalOpen && (
      <div className="fixed inset-0  bg-opacity-50 flex justify-center items-center z-50 p-4 sm:p-6">
